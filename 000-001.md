...
<div class="intro-page-container">
  <div class="row">
    ...
    <ul class="col s12 m4 l3 collection with-header">
      <li class="collection-header"><h6>COVER DESIGN & PRINTING</h6></li>
      <li class="collection-item">Milo Wippermann</li>
      <li class="collection-item">Pearl Friedland</li>
    </ul>
    <ul class="col s12 m4 l3 collection with-header">
      <li class="collection-header"><h6>INDEXERS</h6></li>
      <li class="collection-item">Sophie Anderson</li>
      <li class="collection-item">Ella Blood</li>
      <li class="collection-item">Sofia Candiani </li>
      <li class="collection-item">Jamaal Clarke </li>
      <li class="collection-item">maciej dzumala </li>
      <li class="collection-item">Brooks Finnie </li>
      <li class="collection-item">Emma Claire Foley </li>
      <li class="collection-item">Alé Gomez</li>
      <li class="collection-item">Quinn Gruber</li>
      <li class="collection-item">Skye Levine</li>
      <li class="collection-item">Sabrina Li</li>
      <li class="collection-item">Saundra Norton </li>
      <li class="collection-item">Rachelle Rahmé </li>
      <li class="collection-item">Victoria Anne Reis</li>
      <li class="collection-item">Jane Scheiber </li>
      <li class="collection-item">Theodore “Teddy” Secor </li>
      <li class="collection-item">Sam Stafford</li>
      <li class="collection-item">Flannery Strain </li>
      <li class="collection-item">Isabel Streiffer </li>
      <li class="collection-item">Leif D. Wood </li>
      <li class="collection-item">Camila Valle </li>
      <li class="collection-item">Madeline Zuzevich</li>
    </ul>
    <ul class="col s12 m4 l3 collection with-header">
    ...
    <ul class="col s12 m4 l3 collection with-header">
      ...
      <li class="collection-item">Kireji</li>
    </ul>
